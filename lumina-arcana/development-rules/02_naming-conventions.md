...
| 種類 | 形式 | 例 | 発番台帳 |
|---|---|---|---|
| カード(メジャー) | `LA-M-{00-21}`(0始まり・22枚) | `LA-M-00` | [master-library/06](../master-library/06_card-master.md) |
| カード(マイナー) | `LA-S{1-4}-{01-14}` | `LA-S1-01` | 同上 |
| テンプレート識別子 | `LA-TEMPLATE-00` | `LA-TEMPLATE-00` | 記入見本専用。実カードの Card ID パターンとは一致しない([card-database/_templates/](../card-database/_templates/)) |
...
- カードファイル: `{card-id}_{slug}.md` → `LA-M-00_cradle-of-life.md`
...
| 日付 | 内容 |
|---|---|
| 2026-07-18 | ⚠️ ユーザー決定によりメジャーの Card ID を `LA-M-00`〜`LA-M-21`(0始まり)に確定(2026-07-16の決定を撤回)。テンプレート識別子を `LA-TEMPLATE-00` に変更 |
| 2026-07-16 | (撤回済み)ユーザー決定により LA-M-00 をテンプレート専用予約IDとして追記。メジャーの正式範囲を LA-M-01〜LA-M-22 に改訂 |
| 2026-07-16 | 初版作成 |
