...
import { availableMagic, harmsEnemy, isMending } from '@mugen/core/magic/magic';
import { MAGIC_DEFS } from '@mugen/content/magic/magicDefs';
import { decideTurn, magicBlocked } from '@mugen/game/battle/magicChoice';
import { elementClass, type Element } from '@mugen/game/battle/damageType';
import {
...
import { locationBackground, type LocationId } from '@mugen/content/locations/locationVisuals';
