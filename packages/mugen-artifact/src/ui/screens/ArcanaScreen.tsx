...
import {
  ...
  type ArcanaDef,
  type ArcanaRecord,
} from '@mugen/core/arcana/arcana';
import { ARCANA_DEFS } from '@mugen/content/arcana/arcanaDefs';
import { UNKNOWN_ARCANA_DEFS, type UnknownArcanaDef } from '@mugen/content/arcana/unknownArcana';
import { accidentDef } from '@mugen/content/summon/accidents';
