...
import {
  ...
  useStatLabel,
  type Inventory,
} from '@mugen/core/economy/items';
import { sellPriceOf } from '@mugen/core/economy/shop';
import { itemRefusalLine, refuseUse } from '@mugen/game/battle/battleLogic';
import type { BagUseResult } from '@mugen/core/world/world';
import {
  BATTLE_HP_HOLDER,
  BATTLE_MP_HOLDER,
  type PartyCondition,
} from '@mugen/core/party/condition';
import type { ItemUseKind } from '@mugen/core/economy/items';
