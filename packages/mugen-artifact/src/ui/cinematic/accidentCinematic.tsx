...
import type { SummonAccidentAbility } from '@mugen/core/summon/summonAccident';
import type { UnknownArcanaDef } from '@mugen/content/arcana/unknownArcana';
import ancientDragonArt from '@mugen/assets/files/arcana/unknown-ancient-dragon.png';
import ancientBreathArt from '@mugen/assets/files/arcana/ancient-breath.png';
