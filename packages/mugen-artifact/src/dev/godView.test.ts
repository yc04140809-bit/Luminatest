...
import { INITIAL_CLOCK, addDays, toAbsoluteDay } from '@mugen/core/time/calendar';
import type { MemoryEvent } from '@mugen/core/memory/types';
import { canonAsWorldMemories } from '@mugen/core/life/canonBridge';
import {
  advanceTime,
  emptyWorld,
  observe,
  ...
  settle,
  type WorldLifeRules,
} from '@mugen/core/life/engine';
import type { WorldLifeState } from '@mugen/core/life/types';
import {
  ALDEN_REGION,
  GALD,
  LINA,
  ...
  PORT_REGION,
  WORLD_PEOPLE,
} from '@mugen/content/world/mugenWorld';
import { GREENWOOD_PRELUDE } from '@mugen/content/world/galdLife';
import {
  isolatedPeople,
  memoriesFor,
  observeWorld,
...
import type { CharacterState } from '@mugen/core/characters/types';
import { INITIAL_LINA_STATE } from '@mugen/content/characters/lina';
import { INITIAL_BAKERY_OWNER_STATE } from '@mugen/content/characters/bakeryOwner';
